 ...
 */
public class KeyAndCertificateHandlerBeanConfigurationProperties extends KeyAndCertificateHandlerConfigurationProperties implements
    CommonBeanCandidate {
  ...
  public void afterPropertiesSet() throws Exception {
    Assert.hasText(this.beanName, "Missing bean-name for key and certificate handler bean configuration");
  }
