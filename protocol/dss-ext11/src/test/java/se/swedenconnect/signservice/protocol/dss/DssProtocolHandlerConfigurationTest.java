...
/**
 * Test cases for DssProtocolHandlerConfiguration.
 */
public class DssProtocolHandlerConfigurationTest {
  ...
  public void testFactoryClass() {
    final DssProtocolHandlerConfiguration conf = new DssProtocolHandlerConfiguration();
    Assertions.assertEquals(DssProtocolHandlerFactory.class.getName(), conf.getFactoryClass());
  }
