 ...
 */
public interface IdentityAttribute<T> extends IdentityAttributeName {
  ...
  /**
   * If the attribute is not multi-valued, this method returns the attribute value. If it is, the
