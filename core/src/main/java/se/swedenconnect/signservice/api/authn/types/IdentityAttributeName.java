...
/**
 * A generic representation of an identity attribute name, i.e. an attribute with no value
 * associated.
 */
public interface IdentityAttributeName extends Serializable {
  ...
  /**
   * Gets the name of the identity attribute.
   *
  ...
  /**
   * Gets the "friendly" name of the attribute, i.e., a human readable representation of the name.
   *
