...
/**
 * Represents the different types, i.e., locations in a certificate where identity information can
 * be inserted.
 */
public enum CertificateAttributeType {

  /**
   * Represents an attribute that is a Relative Distinguished Name in the subject field of the
   * certificate.
   */
  RDN("rdn"),

  /**
   * Represents an attribute that is a value placed in a Subject Alternative Names extension of the
   * certificate.
   */
  SAN("san"),

  /**
   * Represents an attribute that is a value placed in a Subject Directory Attribute extension of
   * the certificate.
   */
  SDA("sda");
  ...
  public static CertificateAttributeType fromType(final String type)
    ...
    throw new IllegalArgumentException(
        String.format("%s is not a valid CertificateAttributeType", type));
  }
