 ...
 *
 * @see SignServiceAuditLoggerSingleton
 */
public interface SignServiceAuditLogger {

  /**
   * Audit logs the supplied event.
   *
   * @param event the event to be logged
   * @throws SignServiceAuditLoggerException runtime exception that is thrown if logging fails
   */
  void auditLog(final AuditEvent event) throws SignServiceAuditLoggerException;
