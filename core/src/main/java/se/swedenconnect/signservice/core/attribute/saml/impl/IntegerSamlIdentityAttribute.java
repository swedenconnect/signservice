 ...
 */
public class IntegerSamlIdentityAttribute extends AbstractSamlIdentityAttribute<Integer> {

  /** For serializing. */
  private static final long serialVersionUID = 8176137907784276583L;
   ...
   */
  public IntegerSamlIdentityAttribute(final String identifier, final String friendlyName, final Integer value) {
   ...
   */
  public IntegerSamlIdentityAttribute(final String identifier, final String friendlyName, final List<Integer> values) {
