 ...
 */
public class SignatureHandlerBeanConfigurationProperties extends SignatureHandlerConfigurationProperties
  ...
  public void afterPropertiesSet() throws IllegalArgumentException {
    if (StringUtils.isBlank(this.beanName)) {
      throw new IllegalArgumentException("Missing bean-name for signature handler bean configuration");
    }
  }
