...
public class XMLTBSDataProcessor implements TBSDataProcessor {
  ...
  @Override public TBSProcessingData getTBSData(RequestedSignatureTask signatureTask, PkiCredential signingCredential,
    SignatureAlgorithm signatureAlgorithm) throws SignatureException {
    return null;
  }
}
