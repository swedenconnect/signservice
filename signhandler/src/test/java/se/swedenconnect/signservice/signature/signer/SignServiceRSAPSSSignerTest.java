...
class SignServiceRSAPSSSignerTest {
  ...
  static void init() throws Exception {
    ...
    tbsData = Base64.decode(
      "PGRzOlNpZ25lZEluZm8geG1sbnM6ZHM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvMDkveG1sZHNpZyMiPjxkczpDYW5vbmljYWxp"
    ...
    signature = Base64.decode(
      "TApoUVzCoMf9uhF6rY6DXKWz9NpGeOM6FVNIovT5jnZXFXQkJ6LyTloEkFU8a1cw0KZBIhTzTq25IVlSDhVlxwSF7iPL1vudj"
    ...
    byte[] certBytes = Base64.decode(
      "MIIKzzCCCTegAwIBAgIQJfut41wXYzMb4PO2PyZ5cDANBgkqhkiG9w0BAQsFADCBhzELMAkGA1UEBhMCU0UxFjAUBg"
  ...
  void errorTests() throws Exception {
    ...
    specificErrorTest(tbsData, null, rsaPssSha256, NullPointerException.class);
    log.info("Error test ecdsa algorithm:");
    specificErrorTest(tbsData, TestCredentials.privateRSAKey, TestAlgorithms.ecdsaSha256, SignatureException.class);
    log.info("Error test plain rsa algorithm:");
    specificErrorTest(tbsData, TestCredentials.privateRSAKey, TestAlgorithms.rsaSha256, SignatureException.class);
    log.info("Error test ecdsa key:");
    specificErrorTest(tbsData, TestCredentials.privateECKey, rsaPssSha256, SignatureException.class);
    log.info("Error test null data:");
    specificErrorTest(null, TestCredentials.privateRSAKey, rsaPssSha256, SignatureException.class);
  }
  ...
  void signatureVerificationTest() throws Exception {
    ...
    Digest messageDigestFunction = DigestFactory.getDigest(
      TestAlgorithms.rsaPssSha256.getMessageDigestAlgorithm().getJcaName());
